...
[.tile]
.xref:01-implementation.adoc#instalacion[Instalación de InstructLab]
...
[.tile]
.xref:01-implementation.adoc#entrenamiento[Entrenamiento]
* Cómo entrenar y ajustar el modelo.

[.tile]
.xref:01-implementation.adoc#interaccion[Interacción con el modelo]
* Habla con el modelo para comprobar el efecto de Instructlab.

[.tile]
.xref:01-implementation.adoc#despliegue[Despliegue]
